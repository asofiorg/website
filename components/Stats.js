...
const Stats = () => {
  ...
  return (
    <section
      id="stats"
      className="flex flex-col items-center justify-center bg-yellow-100 dark:bg-yellow-300 p-12"
    >
      ...
      <section className="flex flex-wrap items-center justify-around">
        {cards.map((i, k) => (
          <article
            key={k}
            className="rounded-md p-4 w-72 h-64 bg-yellow-200 dark:bg-yellow-400 m-2"
          >
